...
class WN(torch.nn.Module):
    ...
    def __init__(
        ...
        if c_in_channels > 0:
            ...
            self.cond_layer = torch.nn.utils.parametrizations.weight_norm(cond_layer, name="weight") # pentru ca am coborat versiunea de pytortch si cuda, weight_norm a fost mutat in parametrizations or smth si in aceasta versiune mai veche se afla in .utils
        ...
        for i in range(num_layers):
            ...
            in_layer = torch.nn.utils.parametrizations.weight_norm(in_layer, name="weight") # aceeasi problema ca la cond_layer - nu poate fi accesat .parametrizations
